    ...
    def lab(m,plan,natural,ymax,ymin):
        ...
        for j in range(len(plan)):
            for i in range(len(plan[14]),m+10):
                ...
                plan[j].append(randint(int(ymin),int(ymax)))
        ...
        if Gp>Gt:
            ...
            blist1 = [str('%.3f' % blist[0]), " + " + str('%.3f' % blist[1]), " + " + str('%.3f' % blist[2]), " + " + str('%.3f' % blist[3]),
                      " + " + str('%.3f' % blist[4]), " + " + str('%.3f' % blist[5]), " + " + str('%.3f' % blist[6]),
                      " + " + str('%.3f' % blist[7])," + " + str('%.3f' % blist[8])," + " + str('%.3f' % blist[9])," + " + str('%.3f' % blist[10]),]
        ...
        kr = kr + k + r
        ln = ln + l + n
        print('Кількість значимих коефіцієнтів: ', kr)
        print('Кількість незначимих коефіцієнтів: ', ln)
